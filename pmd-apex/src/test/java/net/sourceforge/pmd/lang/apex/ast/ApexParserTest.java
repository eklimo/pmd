...
public class ApexParserTest extends ApexParserTestBase {
    ...
    public void understandsSimpleFile() {
        ...
        // Exercise
        ApexNode<CompilationUnit> rootNode = parse(code);
    ...
    public void verifyLineColumnNumbers() {
        ApexNode<CompilationUnit> rootNode = parse(testCodeForLineNumbers);
    ...
    public void verifyLineColumnNumbersWithWindowsLineEndings() {
        ...
        ApexNode<CompilationUnit> rootNode = parse(windowsLineEndings);
        assertLineNumbersForTestCode(rootNode);
    }

    private void assertLineNumbersForTestCode(ApexNode<CompilationUnit> rootNode) {
    ...
    public void checkComments() {
        ...
        ApexNode<CompilationUnit> root = parse(code);
    ...
    public void parsesRealWorldClasses() throws Exception {
        ...
        for (File file : fList) {
            if (file.isFile() && file.getName().endsWith(".cls")) {
                ...
                ApexNode<CompilationUnit> rootNode = parse(sourceCode);
    ...
    public void parseInheritedSharingClass() throws IOException {
        ...
        ApexNode<CompilationUnit> rootNode = parse(source);
        Assert.assertNotNull(rootNode);
    }
